...
var cwd             = process.cwd();
var loadControllers = require('./sails/_loadControllers');
var loadPolicies    = require('./sails/_loadPolicies');
...
var self = module.exports = {
  ...
  loadAndRegisterFiles: function (sails){
    async.parallel([
      ...
      if (err) {
        sails.log.warn('sails-hook-user-authorization:: Error encountered trying to register files: ', err);
      }
    });
  }
}
